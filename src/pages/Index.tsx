    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              <span className="text-xl font-bold text-primary">ГАРАНТ ПАРТНЕР</span>
              <span className="text-xs text-gray-500">FACILITY & SERVICES MANAGEMENT</span>
            </div>
          </div>
          <nav className="hidden md:flex items-center gap-6">
            ...
            <a href="#clients" className="text-sm font-medium hover:text-primary">Клиенты</a>
      ...
      <main className="flex-1">
        ...
        <section 
          ...
          style={{
            backgroundImage: "linear-gradient(rgba(0, 53, 102, 0.7), rgba(0, 53, 102, 0.7)), url('https://cdn.poehali.dev/files/592c3f8f-0df1-4fa3-b659-765244cc04f3.jpg')",
            ...
            <div className="flex flex-col md:flex-row gap-12">
              <div className="flex-1 animate-on-scroll">
                ...
                <p className="text-gray-700 mb-6">
                  УК «Гарант-Партнер» - это команда профессионалов, мы специализируемся на комплексном обслуживании 
                  зданий и территорий:
                </p>
                ...
                <p className="text-gray-700">
                  Среди наших Заказчиков - коммерческие и государственные структуры, которые, выбрав нас в качестве 
              ...
              <div className="flex-1 flex flex-col gap-6 animate-on-scroll">
                <Card>
                  ...
                  <CardContent>
                    <p className="text-gray-700">
                      Наш персонал квалифицирован и имеет опыт практической работы в офисных, 
                      торговых, складских и производственных зданиях и сооружениях.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-gray-700">
                      Компания владеет хорошей производственной, технической базой и складскими 
                      помещениями. При выполнении работ используется оборудование от ведущих производителей.
                    </p>
                  </CardContent>
                </Card>
              </div>
        ...
        <section id="services" className="py-16">
          <div className="container mx-auto px-4 md:px-6">
            <h2 className="text-3xl font-bold text-center mb-2">ЧТО МЫ <span className="text-primary">ДЕЛАЕМ</span>?</h2>
        ...
        <section id="clients" className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 md:px-6">
            <h2 className="text-3xl font-bold mb-2">С КЕМ <span className="text-primary">МЫ РАБОТАЕМ</span></h2>
            <div className="w-20 h-1 bg-primary mb-12"></div>
            
            <div className="mb-10">
              <p className="text-gray-700 max-w-3xl">
                Комплексное обслуживание объектов недвижимости с использованием профессионального оборудования 
                и материалов, позволяет нам качественно выполнять поставленные задачи
              </p>
            </div>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="animate-on-scroll">
                ...
                <div className="w-20 h-1 bg-primary mb-6"></div>
                <p className="text-gray-700 mb-6">
                  Оставьте свои контактные данные, и наш менеджер свяжется с вами для обсуждения деталей сотрудничества.
                </p>
                ...
                <div className="flex gap-4 mt-6">
                  <a href="#" className="bg-primary text-white p-2 rounded-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <div className="flex flex-col">
                  <span className="text-xl font-bold text-white">ГАРАНТ ПАРТНЕР</span>
                  <span className="text-xs text-gray-400">FACILITY & SERVICES MANAGEMENT</span>
                </div>
              </div>
              <p className="text-gray-400 mb-4">
                Комплексное обслуживание зданий и сооружений. Профессиональный подход к управлению недвижимостью.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="#about" className="text-gray-400 hover:text-white">О компании</a>
                </li>
                <li>
                  <a href="#services" className="text-gray-400 hover:text-white">Услуги</a>
                </li>
                <li>
                  <a href="#clients" className="text-gray-400 hover:text-white">Клиенты</a>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center gap-2">
                  ...
                  <span className="text-gray-400">123456, г. Москва, ул. Примерная, д. 123</span>
                </li>
                <li className="flex items-center gap-2">
